...
const result =  await fetch(`https://api.artic.edu/api/v1/artworks/search?q=${encodedSearchString}&fields=id,title,image_id&limit=16&page=${page}`)
        ...
        <div class="box">
            <div class="body">
                <div class="imgContainer">
                    <img src="https://www.artic.edu/iiif/2/${parsedResponse.data[i].image_id}/full/843,/0/default.jpg">
                </div>
                <div class="content d-flex flex-column align-items-center justify-content-center">
                    <div>
                        <h3 class="text-white fs-5">${parsedResponse.data[i].title}</h3>
                        <p class="fs-6 text-white">${parsedResponse.data[i].artist_display}</p>
                    </div>
                </div>
            </div>
        </div>
